  ...
  1: [function (require, module, exports) {
    ...
    var vg = module.exports = { VERSION: "0.1.1", PI: Math.PI, TAU: 2 * Math.PI, DEG_TO_RAD: .0174532925, RAD_TO_DEG: 57.2957795, SQRT3: Math.sqrt(3), TILE: "tile", ENT: "entity", STR: "structure", HEX: "hex", SQR: "square", ABS: "abstract" }; vg.Board = function (e, t) {
      ...
      cellToPixel: function cellToPixel(e) {
        ...
        var s = this; vg.Tools.getJSON({
          url: e, callback: function callback(e) {
      ...
      var e = function e(_e, t, i, s, n) {
        ...
        active: !0, params: null, execute: function execute(e) {
        ...
        memorize: !1, _shouldPropagate: !0, active: !0, validateListener: function validateListener(e, t) {
      ...
      manager: null, imageLoader: null, crossOrigin: !1, init: function init(e) {
    ...
    (function (global) {
      ...
      mergeIf(keyCodeToInfoTable, 'moz', {
        ...
        0xBD: {
          code: 'NumpadSubtract', keyCap: '-', location: NUMPAD // [USB: 0x56]
        }
      });
      ...
      mergeIf(keyCodeToInfoTable, 'chrome-mac', {
        0x5D: {
          code: 'OSRight', location: RIGHT // [USB: 0xe7]
        }
      });
      ...
      if (0) {
        mergeIf(keyCodeToInfoTable, 'chrome-win', {
          ...
          0xDF: {
            code: 'Backquote', keyCap: '`' // [USB: 0x35] `~ (US Standard 101)
          }
        });
      ...
      mergeIf(keyCodeToInfoTable, 'ios', {
        0x0A: {
          code: 'Enter', location: STANDARD // [USB: 0x28]
        }
      });
      ...
      mergeIf(keyCodeToInfoTable, 'safari-mac', {
        ...
        0xE5: {
          code: 'KeyQ', keyCap: 'Q' // [USB: 0x14] On alternate presses, Ctrl+Q sends this
        }
      });
      ...
      locationTable[LEFT] = {
        ...
        0x12: {
          code: 'AltLeft', location: LEFT // [USB: 0xe2]
        }
      };
      locationTable[RIGHT] = {
        ...
        0x12: {
          code: 'AltRight', location: RIGHT // [USB: 0xe6]
        }
      };
      locationTable[NUMPAD] = {
        0x0D: {
          code: 'NumpadEnter', location: NUMPAD // [USB: 0x58]
        }
      };
      ...
      mergeIf(locationTable[NUMPAD], 'moz', {
        ...
        0x6B: {
          code: 'NumpadAdd', location: NUMPAD // [USB: 0x57]
        }
      });
      mergeIf(locationTable[LEFT], 'moz-mac', {
        0xE0: {
          code: 'OSLeft', location: LEFT // [USB: 0xe3]
        }
      });
      ...
      mergeIf(locationTable[NUMPAD], 'chrome-mac', {
        0x0C: {
          code: 'NumLock', location: NUMPAD // [USB: 0x53]
        }
      });
      ...
      mergeIf(locationTable[NUMPAD], 'safari-mac', {
        ...
        0xBF: {
          code: 'NumpadDivide', location: NUMPAD // [USB: 0x54]
        }
      });
    ...
    require('./mousedrag-controls');
    require('./movement-controls');
    require('./trackpad-controls');

  }, { "./checkpoint-controls": 12, "./gamepad-controls": 13, "./keyboard-controls": 15, "./movement-controls": 16, "./touch-controls": 17, "./trackpad-controls": 18, "./mousedrag-controls": 43 }], 15: [function (require, module, exports) {
    'use strict';
    ...
    module.exports = AFRAME.registerComponent('mousedrag-controls', {
      ...
      onMouseDown: function (e) {
        ...
        if (this.data.reverseEnabled) {
          this.direction = 1;
          this.y_data = -(e.pageY / window.innerHeight) * 2 + 1;
          console.log("X value: " + e.clientX + " Y value: " + this.y_data);
        }
